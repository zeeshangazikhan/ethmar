      ...
      <header className="relative min-h-[60vh] md:min-h-[70vh] flex flex-col bg-[#0b1320]">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end py-16 sm:py-20 md:py-24 px-4 sm:px-8 md:px-16">
          <div className="max-w-[1000px] mx-auto w-full">
            {/* Back Link */}
            <Link href={`/${locale}/blog`} className="inline-flex items-center gap-2 text-white/60 hover:text-white font-serif text-[12px] sm:text-[13px] tracking-[0.15em] uppercase mb-6 sm:mb-8 transition-colors">
              <ArrowLeft className={`w-4 h-4 ${isArabic ? 'rotate-180 group-hover:-translate-x-1' : 'group-hover:translate-x-1'}`} />
            ...
            <h1 className="text-white font-serif text-[28px] sm:text-[40px] md:text-[52px] lg:text-[60px] leading-[1.1] tracking-[0.02em] mb-6 sm:mb-8">
              {t(`blogPosts.post${post.id}.title`)}
            </h1>
            {/* Meta */}
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-white/50">
              <span className="flex items-center gap-2 font-serif text-[12px] sm:text-[14px]">
                ...
                {t(`blogPosts.post${post.id}.date`)}
              </span>
              <span className="flex items-center gap-2 font-serif text-[12px] sm:text-[14px]">
                <Clock className="w-4 h-4" />
                {t(`blogPosts.post${post.id}.readTime`)}
              </span>
              <span className="flex items-center gap-2 font-serif text-[12px] sm:text-[14px]">
                <User className="w-4 h-4" />
                {t(`blogPosts.post${post.id}.author`)}
              </span>
            </div>
          </div>
        </div>
      ...
      <article className="py-20 sm:py-28 md:py-32 px-4 sm:px-8 md:px-16 bg-[#fffcf8]">
        <div className="max-w-[1000px] mx-auto w-full">
          ...
          <div className="flex items-center gap-4 mb-12">
            ...
            <span className="text-[#b69c6b] text-[10px] tracking-[0.4em] font-serif uppercase">{t('blog.article')}</span>
            <div className="h-[1px] flex-1 bg-gradient-to-r from-transparent via-[#b69c6b]/40 to-transparent"></div>
          </div>
          ...
          <p className="text-[#1a1815] font-serif text-[20px] sm:text-[22px] md:text-[24px] leading-[1.65] mb-14 sm:mb-16 md:mb-20 font-medium text-center">
            {t(`blogPosts.post${post.id}.excerpt`)}
          </p>
          ...
          <div className="mt-20 sm:mt-24 md:mt-28 pt-10 sm:pt-12 md:pt-14 border-t-2 border-[#b69c6b]/30">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-8">
              <div>
                <p className="font-serif text-[11px] sm:text-[12px] tracking-[0.35em] uppercase text-[#191817]/40 mb-5 font-medium">{t('common.shareArticle')}</p>
                <div className="flex items-center gap-4">
                  <a href="#" className="w-12 h-12 flex items-center justify-center bg-[#0b1320] hover:bg-[#b69c6b] text-white transition-all duration-300 transform hover:scale-110" aria-label={t('blog.shareOnFacebook')}>
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="#" className="w-12 h-12 flex items-center justify-center bg-[#0b1320] hover:bg-[#b69c6b] text-white transition-all duration-300 transform hover:scale-110" aria-label={t('blog.shareOnLinkedin')}>
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  <a href="#" className="w-12 h-12 flex items-center justify-center bg-[#0b1320] hover:bg-[#b69c6b] text-white transition-all duration-300 transform hover:scale-110" aria-label={t('blog.shareOnTwitter')}>
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                  </a>
                  <button className="w-12 h-12 flex items-center justify-center bg-[#0b1320] hover:bg-[#b69c6b] text-white transition-all duration-300 transform hover:scale-110" aria-label={t('blog.copyLink')}>
              ...
              <div className="flex items-center gap-5 bg-gradient-to-r from-[#f2efe6] to-[#f9f7f4] p-6 sm:p-8 border border-[#b69c6b]/20">
                ...
                <div>
                  <p className="font-serif text-[16px] sm:text-[18px] text-[#191817] mb-1 font-medium">{t(`blogPosts.post${post.id}.detailAuthor`)}</p>
                  <p className="font-serif text-[13px] sm:text-[14px] text-[#191817]/60">{t(`blogPosts.post${post.id}.detailAuthorRole`)}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {relatedPosts.map((relatedPost) => (
              <Link key={relatedPost.id} href={`/${locale}/blog/${relatedPost.slug}`} className="group">
                  ...
                  <div className="relative h-[300px] sm:h-[340px] md:h-[380px] overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className={`px-3 py-1.5 text-[10px] tracking-[0.15em] uppercase font-serif ${relatedPost.category === 'news' ? 'bg-[#b69c6b] text-white' : 'bg-white text-[#191817]'}`}>
                        {relatedPost.category === 'news' ? t('blog.categoryNews') : t('blog.categoryPress')}
                      </span>
                    </div>
                  </div>
                  {/* Content */}
                  <div className="p-6 sm:p-8 flex flex-col flex-1">
                    ...
                    <div className="flex items-center gap-3 mb-4 text-[#191817]/40">
                      <span className="flex items-center gap-1.5 font-serif text-[11px] tracking-wide">
                        ...
                        {t(`blogPosts.post${relatedPost.id}.date`)}
                      </span>
                      <span className="w-1 h-1 bg-[#191817]/20 rounded-full"></span>
                      <span className="flex items-center gap-1.5 font-serif text-[11px] tracking-wide">
                        <Clock className="w-3 h-3" />
                        {t(`blogPosts.post${relatedPost.id}.readTime`)}
                      </span>
                    </div>
                    {/* Title */}
                    <h3 className="text-[#191817] font-serif text-[18px] sm:text-[20px] leading-[1.3] mb-3 group-hover:text-[#b69c6b] transition-colors flex-1">
                      {t(`blogPosts.post${relatedPost.id}.title`)}
                    </h3>
                    {/* Read More */}
          ...
          <div className="flex justify-center mt-12 sm:mt-16 md:mt-20">
            <Link href={`/${locale}/blog`} className="group inline-flex items-center gap-3 px-8 sm:px-12 py-4 bg-[#0b1320] text-white font-serif text-[12px] sm:text-[13px] tracking-[0.2em] uppercase hover:bg-[#191817] transition-colors">
              {t('common.viewAll')}
