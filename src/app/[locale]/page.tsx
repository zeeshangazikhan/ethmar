      ...
      >
        ...
        <div className="py-6 sm:py-10 px-4 sm:px-8 md:px-16">
          <div className="flex justify-between items-center">
            <span className="font-serif text-[18px] sm:text-[20px] md:text-[26px] tracking-[0.15em] text-[#191817]">{t('common.brand')}</span>
            <button 
              onClick={() => {
                setMenuOpen(false)
      ...
      <header className="relative h-screen flex flex-col bg-[#0b1320]">
        ...
        <div className="absolute top-0 left-0 right-0 z-50 py-6 sm:py-10 px-4 sm:px-8 md:px-16">
          ...
          <nav className="md:hidden flex items-center justify-between text-white">
            ...
            <div className="font-serif text-[18px] sm:text-[20px] tracking-[0.15em]">{t('common.brand')}</div>
          ...
          <nav className="hidden md:flex justify-between items-center text-white">
            <div className="flex items-center">
               <span className="font-serif text-[18px] sm:text-[20px] md:text-[26px] tracking-[0.15em]">{t('common.brand')}</span>
            </div>
              ...
              {sectors.map((sector) => (
                <div key={sector.id} className="flex-[0_0_78vw] sm:flex-[0_0_60vw] md:flex-[0_0_33.333vw] min-w-0 px-1 sm:px-1">
                  ...
                  <div className="mt-4 sm:mt-6 px-2 sm:px-4">
                    <h3 className={`text-[#191817] font-serif text-[13px] sm:text-[15px] md:text-[18px] uppercase tracking-[0.1em] sm:tracking-[0.15em] md:tracking-[0.2em] ${isArabic ? 'text-right' : 'text-left'} leading-relaxed`}>{sector.title}</h3>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-[1440px] mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 sm:gap-8">
             <div className="flex flex-col items-start sm:items-end gap-4 w-full sm:w-auto mt-4 sm:mt-0 md:order-2">
                ...
                <div className={`flex flex-wrap gap-4 sm:gap-6 text-[12px] sm:text-[13px] md:text-[15px] opacity-70 ${isArabic ? 'text-right sm:text-left' : 'text-left sm:text-right'}`}>
